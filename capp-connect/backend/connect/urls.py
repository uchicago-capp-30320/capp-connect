...
urlpatterns = [
    ...
    path(
        "ccserver/resources/", cc_views.GetResourceList.as_view(), name="all_resources"
    ),
    path("ccserver/resources/<int:pk>/", cc_views.GetResource.as_view(), name="resource_detail"),
    path(
